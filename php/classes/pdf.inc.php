...
class pdf extends fpdf\FPDF {
  ...
  function __construct($belegnummer) {
  ...
  function getHoehe($string,$zeilenhoehe=5){
  ...
  function Artikel($name,$menge,$preis,$einheit){
    ...
    if($name!='Festpreis'){$this->positionen_zaehler++;}
  }
  function Endpreis(){
    ...
    else if($this->belegdaten['endbetrag_typ'] == 'netto'){
